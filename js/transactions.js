...
function renderTable(list) {
    ...
    itemsToRender.forEach(item => {
        ...
        if (mobileExpensesList) {
            ...
            const typeIcon = item.type === 'income' ? '<i class="fa-solid fa-arrow-up-long" style="color:var(--success); font-size:0.95rem;"></i>' : '<i class="fa-solid fa-arrow-down-long" style="color:var(--danger); font-size:0.95rem;"></i>';
